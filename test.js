...
// task 1
const answer1 = data.map(element => ({id: element.id, username: element.username}))
console.log({answer1})
...
console.log(answer8) // без фигурных скобок '{}' консоль выходит данные польностью

// task 9
const answer9 = data.reduce((acc,curr) => [...acc, curr.username.length > 12 ? curr : null], []).filter(el => Boolean(el))
console.log({answer9})
